      ...
      <header className={`sticky top-0 bg-white text-legal-navy py-4 px-4 md:px-6 shadow-md relative z-50 border-b border-gray-200 ${isPWA ? 'safe-area-top' : ''}`}>
        <div className="container mx-auto flex items-center justify-between">
          <div className="flex items-center">
            <Link to="/" className="flex items-center gap-2">
              ...
              />
              <span className="hidden sm:inline-block font-serif font-bold text-lg md:text-xl text-legal-navy">
                DocuCreator Pro
              </span>
            </Link>
          </div>
          ...
          {isMobile ? (
            ...
            <>
              <div className="hidden md:flex items-center space-x-8">
                ...
                <Link to="/seo-generator" className="hover:text-legal-gold transition-colors">SEO Generator</Link>
        ...
        {isMobile && mobileMenuOpen && (
          <div className="absolute top-full left-0 w-full bg-white shadow-lg py-4 px-6 flex flex-col space-y-4 animate-fade-in border-t border-gray-200">
            ...
            <Link to="/seo-generator" className="py-2 hover:text-legal-gold transition-colors text-legal-navy" onClick={() => setMobileMenuOpen(false)}>
              SEO Generator
            </Link>
